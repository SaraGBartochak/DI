...
let inputUser = document.querySelector("searchplace");
...
//   })
  ...
  class MeteoCard {
    ...
    createDomElem(){
      ...
      this.domElem.classList.add(`card`)
      ...
      title.classList.add(`card-title`,`div`)
      title.textContent = this.name
      let country = document.createElement('span')
      country.textContent = this.country
      country.classList.add('div',`badge`, `bg-primary`)
      ...
      imgContainer.classList.add(`text-center` , `div`)
